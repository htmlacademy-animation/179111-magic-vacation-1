...
/* harmony import */ var _easing_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./easing-functions.js */ "./source/js/modules/canvas/easing-functions.js");
...
class Animation {
  constructor(options) {
    ...
    if (!this.options.easing) {
      this.options.easing = _easing_functions_js__WEBPACK_IMPORTED_MODULE_0__["default"].easeLinear;
    }
...
class Scene2DSeaCalf extends Scene2D {
  ...
  initPlaneAnimations() {
    this.animations.push(new Animation({
      ...
      duration: 500,
      delay: 700,
      easing: _easing_functions_js__WEBPACK_IMPORTED_MODULE_0__["default"].easeInQuad
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new Animation({
      ...
      duration: 2000,
      delay: 500,
      easing: _easing_functions_js__WEBPACK_IMPORTED_MODULE_0__["default"].easeOutElastic
    }));
...
/***/ "./source/js/modules/canvas/easing-functions.js":
/*!******************************************************!*\
  !*** ./source/js/modules/canvas/easing-functions.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/counter-prizes.js":
/*!*********************************************!*\
  !*** ./source/js/modules/counter-prizes.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var _history_prize_background__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./history-prize-background */ "./source/js/modules/history-prize-background.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (prev === `story` && next === `prizes`) {
      _history_prize_background__WEBPACK_IMPORTED_MODULE_1__["default"].enable();
      setTimeout(() => {
        this.hideAllScreens();
        this.showActiveScreen();
        _history_prize_background__WEBPACK_IMPORTED_MODULE_1__["default"].disable();
      }, 600);
    } else {
      this.hideAllScreens();
      this.showActiveScreen();
...
/***/ "./source/js/modules/history-prize-background.js":
/*!*******************************************************!*\
  !*** ./source/js/modules/history-prize-background.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (backgroundScreen);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _canvas_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvas/animation.js */ "./source/js/modules/canvas/animation.js");
    ...
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        if (targetEl[0].id === `result`) {
          const sceneCanvasAnimation = new _canvas_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/***/ "./source/js/modules/text-splitter.js":
/*!********************************************!*\
  !*** ./source/js/modules/text-splitter.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ((node, animationOptions) => {
...
/* harmony import */ var _modules_text_splitter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/text-splitter */ "./source/js/modules/text-splitter.js");
/* harmony import */ var _modules_counter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/counter */ "./source/js/modules/counter.js");
/* harmony import */ var _modules_counter_prizes__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/counter-prizes */ "./source/js/modules/counter-prizes.js");
// modules
...
Object(_modules_counter__WEBPACK_IMPORTED_MODULE_10__["default"])(5);
Object(_modules_counter_prizes__WEBPACK_IMPORTED_MODULE_11__["default"])(`cases`, 1, 7);
Object(_modules_counter_prizes__WEBPACK_IMPORTED_MODULE_11__["default"])(`codes`, 11, 900);
...
window.addEventListener(`load`, () => {
  ...
  Object.keys(animationOptions).forEach((className) => {
    Object(_modules_text_splitter__WEBPACK_IMPORTED_MODULE_9__["default"])(document.querySelector(`.${className}`), animationOptions[className]);
  });
});
